...
Unknown tokens: Tokens (e.g., words) that were not encountered in the training data. These are often represented by a special <unk> token during pre-processing to allow the model to handle unseen vocabulary.
